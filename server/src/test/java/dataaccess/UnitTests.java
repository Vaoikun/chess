...
public class UnitTests {
    ...
    private final SQLUserDAO sqlUserRefer = new SQLUserDAO();
    private final SQLAuthDAO sqlAuthRefer = new SQLAuthDAO();
    private final SQLGameDAO sqlGameRefer = new SQLGameDAO();

    private final UserData userData = new UserData("BOY", "1234", "boi@byu.edu");
    private final UserData userDataFailed = new UserData("", "1234", "boi@byu.edu");
